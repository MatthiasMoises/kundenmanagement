...
class Angebot {
	...
	public function setAngebotsNr($angebotsNr) {
		$this->angebotsNr = $angebotsNr;
	}
	
	public function getAngebotsNr() {
		return $this->angebotsNr;	
	}
	
	public function setAngebotsDatum($angebotsDatum) {
		$this->angebotsDatum = $angebotsDatum;	
	}
	
	public function getAngebotsDatum() {
