...
<title>Neue Rechnung erstellen</title>
...
<div style="float:left;">
<p>
<button style="margin-left:500px;" id="save_account" name="save_account" onclick="javascript:check_account_nr()">Rechnung speichern</button>
</p>
</div>
